...
public:
    Window() {}
    virtual ~Window() {}
    virtual void fetchInput(char &buffer) = 0; 
}; 

class WindowNC : public Window
{
public:
    WINDOW * boardWindow;
...
public:
    ...
    void fetchInput(char &buffer) override { //Passage par reference pour que le contenu de buffer soit accessible dans d'autres fonctions.
